...
import com.tplink.smb.common.data.management.system.domain.vo.TableInfo;
import com.tplink.smb.common.data.management.system.exception.BadRequestException;
import com.tplink.smb.common.data.management.system.repository.ColumnInfoRepository;
import com.tplink.smb.common.data.management.system.service.GeneratorService;
...
public class GeneratorServiceImpl implements GeneratorService {
  ...
  public PageResult<TableInfo> getTables(String name, int[] startEnd) {
    ...
    for (Object obj : result) {
      ...
      tableInfos.add(
          new TableInfo(
              arr[0], arr[1], arr[2], arr[3], ObjectUtil.isNotEmpty(arr[4]) ? arr[4] : "-"));
    }
    String countSql =
