...
// 文件路径: src/main/java/me/zhengjie/gen/utils/GenericJsonConverter.java
...
/**
 * 通用 JSON 转换器
 * 将任意 Java 对象与 JSON 字符串之间自动转换，用于 JPA 映射 JSON 类型字段
 */
@Converter
public class GenericJsonConverter implements AttributeConverter<Object, String> {
    ...
    /**
     * 将数据库中的 JSON 字符串还原为 Java 对象
     * 默认解析成 Map<String, Object> 层级结构（适合动态 JSON）
     */
    @Override
