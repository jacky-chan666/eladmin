 ...
 */
package com.tplink.smb.common.data.management.system.modules.maint.rest;
...
public class ServerDeployController {
  ...
  public void exportServerDeploy(HttpServletResponse response, ServerDeployQueryCriteria criteria)
      throws IOException {
  ...
  @GetMapping
  @PreAuthorize("@el.check('serverDeploy:list')")
  public ResponseEntity<PageResult<ServerDeployDto>> queryServerDeploy(
  ...
  @PreAuthorize("@el.check('serverDeploy:add')")
  public ResponseEntity<Object> testConnectServerDeploy(
      @Validated @RequestBody ServerDeploy resources) {
