 ...
 */
package com.tplink.smb.common.data.management.system.modules.quartz.rest;
...
import com.tplink.smb.common.data.management.system.modules.quartz.service.QuartzJobService;
import com.tplink.smb.common.data.management.system.modules.quartz.service.dto.JobQueryCriteria;
...
public class QuartzJobController {
  ...
  public ResponseEntity<PageResult<QuartzJob>> queryQuartzJob(
      JobQueryCriteria criteria, Pageable pageable) {
  ...
  @PreAuthorize("@el.check('timing:list')")
  public void exportQuartzJob(HttpServletResponse response, JobQueryCriteria criteria)
      throws IOException {
  ...
  @PreAuthorize("@el.check('timing:list')")
  public void exportQuartzJobLog(HttpServletResponse response, JobQueryCriteria criteria)
      throws IOException {
  ...
  @PreAuthorize("@el.check('timing:list')")
  public ResponseEntity<PageResult<QuartzLog>> queryQuartzJobLog(
      JobQueryCriteria criteria, Pageable pageable) {
