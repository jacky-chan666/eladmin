...
import com.tplink.smb.common.data.management.system.modules.maint.repository.DeployRepository;
import com.tplink.smb.common.data.management.system.modules.maint.websocket.MsgType;
import com.tplink.smb.common.data.management.system.modules.maint.websocket.SocketMsg;
import com.tplink.smb.common.data.management.system.modules.maint.websocket.WebSocketServer;
...
import com.tplink.smb.common.data.management.system.modules.maint.service.DeployService;
import com.tplink.smb.common.data.management.system.modules.maint.service.ServerDeployService;
...
import com.tplink.smb.common.data.management.system.modules.maint.service.dto.DeployQueryCriteria;
import com.tplink.smb.common.data.management.system.modules.maint.service.dto.ServerDeployDto;
import com.tplink.smb.common.data.management.system.modules.maint.service.mapstruct.DeployMapper;
import com.tplink.smb.common.data.management.system.modules.maint.util.ExecuteShellUtil;
import com.tplink.smb.common.data.management.system.modules.maint.util.ScpClientUtil;
import com.tplink.smb.common.data.management.system.utils.*;
...
public class DeployServiceImpl implements DeployService {
    ...
    for (ServerDeployDto deployDTO : deploys) {
      ...
      if (flag) {
        ...
        backupApp(
            executeShellUtil,
            ip,
            app.getDeployPath() + FILE_SEPARATOR,
            app.getName(),
            app.getBackupPath() + FILE_SEPARATOR,
            id);
      }
  ...
  private void stopApp(int port, ExecuteShellUtil executeShellUtil) {
    // 发送停止命令
    executeShellUtil.execute(
        String.format("lsof -i :%d|grep -v \"PID\"|awk '{print \"kill -9\",$2}'|sh", port));
  }
  ...
  public String serverReduction(DeployHistory resources) {
    ...
    String deployDate =
        DateUtil.format(resources.getDeployDate(), DatePattern.PURE_DATETIME_PATTERN);
  ...
  private ExecuteShellUtil getExecuteShellUtil(String ip) {
    ...
    return new ExecuteShellUtil(
        ip, serverDeployDTO.getAccount(), serverDeployDTO.getPassword(), serverDeployDTO.getPort());
  }
  ...
  private ScpClientUtil getScpClientUtil(String ip) {
    ...
    return ScpClientUtil.getInstance(
        ip, serverDeployDTO.getPort(), serverDeployDTO.getAccount(), serverDeployDTO.getPassword());
  }
