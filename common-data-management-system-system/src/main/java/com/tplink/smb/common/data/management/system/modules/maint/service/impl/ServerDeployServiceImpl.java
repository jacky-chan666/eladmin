...
import com.tplink.smb.common.data.management.system.modules.maint.repository.ServerDeployRepository;
import com.tplink.smb.common.data.management.system.modules.maint.service.dto.ServerDeployQueryCriteria;
import com.tplink.smb.common.data.management.system.modules.maint.service.mapstruct.ServerDeployMapper;
...
public class ServerDeployServiceImpl implements ServerDeployService {
  ...
  @Override
  public PageResult<ServerDeployDto> queryAll(
      ServerDeployQueryCriteria criteria, Pageable pageable) {
    Page<ServerDeploy> page =
        serverDeployRepository.findAll(
  ...
  public List<ServerDeployDto> queryAll(ServerDeployQueryCriteria criteria) {
    return serverDeployMapper.toDto(
        serverDeployRepository.findAll(
            (root, criteriaQuery, criteriaBuilder) ->
                QueryHelp.getPredicate(root, criteria, criteriaBuilder)));
  }
  ...
  public void update(ServerDeploy resources) {
    ServerDeploy serverDeploy =
        serverDeployRepository.findById(resources.getId()).orElseGet(ServerDeploy::new);
  ...
  @Override
  public void download(List<ServerDeployDto> queryAll, HttpServletResponse response)
      throws IOException {
