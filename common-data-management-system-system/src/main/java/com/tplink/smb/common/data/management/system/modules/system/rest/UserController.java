...
import com.tplink.smb.common.data.management.system.modules.system.domain.vo.UserPassVo;
...
import com.tplink.smb.common.data.management.system.utils.enums.CodeEnum;
...
public class UserController {
  ...
  @GetMapping
  @PreAuthorize("@el.check('user:list')")
  public ResponseEntity<PageResult<UserDto>> queryUser(
    ...
    List<Long> dataScopes =
        dataService.getDeptIds(userService.findByName(SecurityUtils.getCurrentUsername()));
  ...
  @PreAuthorize("@el.check('user:list')")
  public ResponseEntity<PageResult<UserDto>> getUsersByRole(
      @PathVariable Long roleId, Pageable pageable) {
