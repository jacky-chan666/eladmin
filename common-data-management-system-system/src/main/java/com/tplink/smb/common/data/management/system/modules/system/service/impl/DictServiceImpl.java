...
import com.tplink.smb.common.data.management.system.modules.system.service.mapstruct.DictMapper;
...
public class DictServiceImpl implements DictService {
  ...
  public List<DictDto> queryAll(DictQueryCriteria dict) {
    List<Dict> list =
        dictRepository.findAll((root, query, cb) -> QueryHelp.getPredicate(root, dict, cb));
