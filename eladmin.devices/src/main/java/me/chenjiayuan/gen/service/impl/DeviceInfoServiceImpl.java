...
import com.tplink.smb.common.data.management.system.utils.ValidationUtil;
...
public class DeviceInfoServiceImpl implements DeviceInfoService {
  ...
  public void update(DeviceInfo resources) {
    DeviceInfo deviceInfo =
        deviceInfoRepository.findById(resources.getId()).orElseGet(DeviceInfo::new);
